...
- *Case 2: Asset price at expiration $S_T \leq K$*  
  ...
  - Portfolio B: Put is worth $(K - S_T)$, underlying asset is worth $S_T$, total value = $(K - S_T) + S_T = K$
...
- Synthetic underlying: $S = C - P + K\e^{-rT}$
