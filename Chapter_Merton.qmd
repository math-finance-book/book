...
We consider the idealized case in which the futures contract is continuously marked to market.  Assume there is an instantaneously risk-free asset with rate of return $r$, which could vary randomly over time, and define, as in @sec-c_arbitrage,
...
Because all gains and losses on this portfolio are reinvested, $V$ is the price of a non-dividend-paying asset.  Therefore, under the risk-neutral probability (i.e., using $R$ as the numeraire), the ratio $V/R$ must be a martingale and hence have zero drift.  From Ito's formula,
\begin{align*}
