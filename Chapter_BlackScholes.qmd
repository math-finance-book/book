...
::: {#fig-bs-call-put} 
<iframe height="800" width ="720" src="https://respective-callie-derivative-securities-42155ddc.koyeb.app/"></iframe>
**Black-Scholes Explorer.** The left sidebar has user controls. If it is not visible, use the <i class="bi bi-chevron-right"></i> icon at the top of the figure to open it.
:::
...
::: {#fig-bs-greeks} 
<iframe height="750" width ="720" src="https://general-enrika-derivative-securities-9bc12450.koyeb.app/"></iframe>
**Black-Scholes Greeks Explorer.** The left sidebar has user controls. If it is not visible, use the <i class="bi bi-chevron-right"></i> icon at the top of the figure to open it.
:::
