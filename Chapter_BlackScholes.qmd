...
From @sec-s:reinvestingdividends, we know that $V_t=\mathrm{e}^{qt}S_t$ is the price of a non-dividend-paying portfolio.  From our fundamental pricing @eq-formula, using $V$ as the numeraire, we have
\begin{align*}
