...
By taking the Itô differential of $r(s)$ in the following, one can verify that it is the solution of the Vasicek model \eqref{vasicek}:\footnote{Equation \eqref{vasicek_sol} implies the distributional properties of $r(s)$ stated earlier.
...
reference="vasicekbond"} and Itô's formula (the rule that, if $P=\E^X$,
