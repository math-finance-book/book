...
# Fourier Transforms {#sec-c_fouriertrasform}
...
where $r$ is the risk-free rate, $q$ is the continuous dividend yield, $\sigma$ is the volatility of the Brownian motion component, $W(t)$ is a standard Brownian motion under the risk-neutral probability, 
