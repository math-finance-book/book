...
From this fact and the @eq-tailprob02, we conclude:
...
\end{align*}
and from the @eq-tailprob02 we have
$$\text{prob}^V\!\big(S(T)<K\big) = \mathrm{N}(-d_1)\; .$$
We conclude:
