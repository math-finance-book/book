...
In general, the changes in the yields of an asset and a liability (or two different coupon bonds) will not be equal.  To understand how the changes will be related, note that the @eq-yieldtomaturity of the yield to maturity and the @eq-yieldcurve1 relating a bond price to the yields of discount bonds imply
