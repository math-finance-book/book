# Brownian Motion and Ito Calculus {#sec-c_continuoustime}
...
$$dX(t)= \kappa X(t) dB(t)$$
which agrees with the martingale characterization of $\int_0^t \sigma(X(t),t) dB(t)$.
...
$$ {#eq-exponential112}
and using Taylor's Theorem for small $\Delta t$, $e^{\left(\mu-\frac{\sigma^2}{2}\right) \Delta t} \approx 1+ \left(\mu-\frac{\sigma^2}{2}\right) \Delta t$ and $e^{\sigma \Delta B(t)} \approx 1+ \sigma \Delta B(t) +\frac{1}{2}\sigma^2 (\Delta B(t))^2$ and $(dB(t))^2=\Delta t$.
:::
::: {#exr-nolabel}
