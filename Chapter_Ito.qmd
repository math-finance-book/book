...
Let  
$$Y_t =\exp\left(\int_0^t q(s)\,\mathrm{d} s\right)$$
...
satisfies $\\E[X_t]=1$ and $\\E[X_t|X(s)]=X(s)$ and is an important example of a strictly positive martingale.  Again, these facts can be verified using the formula for the expected value of a lognormal random variable.  Notice we can write
