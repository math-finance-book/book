...
We will now derive equations @eq-geometricaveragev1 and @eq-geometricaveragev2.  We will begin with @eq-geometricaveragev1.
...
The forward-start call pricing formula is of the same form as the Black-Scholes, Margrabe, Black, and Merton formulas, as discussed in @sec-s_matlabimplementations.  We can compute it with our \verb!Generic_Option! pricing function.
...
:::
::: {#exr-nolabel}
 Create a VBA function to value a simple chooser (a chooser option in which $K_c=K_p$ and $T_c=T_p$) using put-call parity to compute $S^*$ as mentioned in @sec-s_choosers.  Verify that the function gives the same result as the function \verb!Chooser!.
:::
::: {#exr-nolabel}
