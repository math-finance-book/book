...
$$
\begin{multline}
-\mathrm{e}^{-rT}K\mathrm{N}(-d_2) + \mathrm{e}^{-rT'}K'\M\!\left(-d_2,-d_2',\sqrt{T/T'}\right) \\- \mathrm{e}^{-q T'}S(0)\M\!\left(-d_1,-d_1',\sqrt{T/T'}\right) \;,
 \end{multline}
$$ {#eq-e_averagehedge2}
...
$$
\begin{multline}
[S(0)-\mathrm{e}^{-rT}D]\mathrm{N}(d_1) + \mathrm{e}^{-rT}(D-K)\mathrm{N}(d_2)\\ +[S(0)-\mathrm{e}^{-rT}D]\M\!\left(-d_1,d_1',-\sqrt{T/T'}\right) \\- \mathrm{e}^{-rT'}K\M\!\left(-d_2,d_2',-\sqrt{T/T'}\right)\;,
\end{multline}
$$ {#eq-e_averagehedge2}
...
$$
\begin{multline}
\mathrm{e}^{-q T_c}S(0)\M\!\left(d_1,d_{1c},\sqrt{T/T_c}\right) - \mathrm{e}^{-rT_c}K_c\M\!\left(d_2,d_{2c},\sqrt{T/T_c}\right)\\ +\mathrm{e}^{-rT_p}K_p\M\!\left(-d_2,-d_{2p} , \sqrt{T/T_p}\right) \\- \mathrm{e}^{-q T_p}S(0)\M\!\left(-d_1 ,-d_{1p} ,\sqrt{T/T_p}\right)\;,
\end{multline}
$$ {#eq-e_averagehedge2}
...
$$
\begin{multline}
\mathrm{e}^{-q_1T}S_1(0)\M\!\left(d_{11},d_1,\frac{\sigma_1-\rho\sigma_2}{\sigma}\right) + \mathrm{e}^{-q_2T}S_2(0)\M\!\left(d_{21},-d_2,\frac{\sigma_2-\rho\sigma_1}{\sigma}\right)\\+ \mathrm{e}^{-rT}K\M(-d_{12},-d_{22},\rho) - \mathrm{e}^{-rT}K\;,
\end{multline}
$$ {#eq-e_averagehedge2}
