...
<iframe width="600" height="500" src=" https://streamlit-quadratic-variation-boo
  k-derivative-securiti-06fd3959.koyeb.app"></iframe>

**Convergence of quadratic variation of approximate Brownian motions.** The left sidebar has user controls. If it is not visible, use the <i class="bi bi-chevron-right"></i> icon at the top of the figure to open it.
:::
...
$$\mathrm{E}_s \left[\int_s^t \rho_u\mathrm{d}   u\right]\; .$$
...
$$\frac{\text{covariance}}{\text{product of standard deviations}}  = \frac{\mathrm{E}_s\int_s^t \rho_u \mathrm{d}   u}{\sqrt{t-s} \sqrt{t-s}} = \frac{1}{t-s}\mathrm{E}_s\int_s^t \rho_u \mathrm{d}   u\; .$$
