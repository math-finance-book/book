...
<iframe width="600" height="500" src="https://streamlit-quadratic-variation-book-derivative-securiti-06fd3959.koyeb.app/"></iframe>
**Convergence of quadratic variation of approximate Brownian motions.** 
The left sidebar has user controls. If it is not visible, use the <i class="bi bi-chevron-right"></i> icon at the top of the figure to open it.
:::
