...
The usefulness of @eq-preformula is that it gives us a formula for the asset price $Y_t$ at any time $t$---and recall that this formula holds for every dividend-reinvested asset.  The formula is obtained from @eq-preformula by multiplying through by $P_t$:

::: {.Principle #principle-fundamental}
In the absence of arbitrage opportunities, prices $P$ and $Y$ of dividend-reinvested assets satisfy
$$
