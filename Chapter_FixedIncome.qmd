...
Assuming $\mathrm{d} \mathbf{y}_t = \alpha_t\,\mathrm{d} t+\sigma_t\,\mathrm{d} B_t$ for a Brownian motion $B$ and some $\alpha$ and $\sigma$, we have
