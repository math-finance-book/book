...
::: {#fig-delta-hedges}
<iframe width="780" height="1000" src="https://wispy-adelle-derivative-securities-7132088b.koyeb.app/"></iframe>

**Simulated Discretely Rebalanced Delta Hedges.** The left sidebar has user controls. If it is not visible, use the <i class="bi bi-chevron-right"></i> icon at the top of the figure to open it.
:::
