...
As in @sec-s_replicatingquantos, borrowing $\mathrm{N}(d_1)V_0$ units of domestic currency at the foreign risk-free rate can be replaced by borrowing the same amount at the domestic risk-free rate and selling $\mathrm{e}^{r_fT}\mathrm{N}(d_1)V_0/X_0$ currency forwards.  This results in:
