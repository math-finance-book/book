...
:::
::: Exercise
 Create a Python function to simulate a path of the exchange rate and the forward exchange rate under the risk-neutral probability, prompting the user to input $X(0)$, $r$, $r_f$, $\sigma_x$, and the maturity $T$ of the forward contract.
:::
::: Exercise
