...
::: {#exr-gbm1}
Use Ito's Lemma to derive the stochastic differential equation for $S_t^2$.  Show that $S(t)^2$ is a geometric Brownian motion if $\mu$ and $\sigma$ are constants and find $\mathrm{E}[S(t)^2]$.
::: 
