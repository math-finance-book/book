...
The chat link at the top right is to a chatbot that can answer questions using the book as a source.  Like any chatbot, it can make mistakes, so check its answers with the sources in the book that it should provide.  The icon on the top left enables toggling between light and dark modes.
