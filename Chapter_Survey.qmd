...
::: {.callout-note}
 ## 
 We will conclude this section with a proof of @eq-holee3.  Let $\varepsilon(t_i)$ denote independent  random variables that equal $\pm \sigma \sqrt{\Delta t}$ with probability $1/2$ each under the risk-neutral probability.  Then we can write
